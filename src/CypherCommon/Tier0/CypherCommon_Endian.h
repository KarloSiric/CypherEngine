...
CYPHER_NODISCARD constexpr u16 Cy_ByteSwap16( u16 nValue ) noexcept
{
    return static_cast<u16>( ( nValue >> 8u ) | ( nValue << 8u ) );
}

// Reverses the byte order of a 32-bit integer.
CYPHER_NODISCARD constexpr u32 Cy_ByteSwap32( u32 nValue ) noexcept
{
...
CYPHER_NODISCARD constexpr u64 Cy_ByteSwap64( u64 nValue ) noexcept
{
...
CYPHER_NODISCARD constexpr char Cy_FourCCChar0( u32 nFourCC ) noexcept
{
    return Cy_FourCCChar( nFourCC, 0u );
}

// Extracts the second byte from a FourCC.
CYPHER_NODISCARD constexpr char Cy_FourCCChar1( u32 nFourCC ) noexcept
{
    return Cy_FourCCChar( nFourCC, 1u );
}

// Extracts the third byte from a FourCC.
CYPHER_NODISCARD constexpr char Cy_FourCCChar2( u32 nFourCC ) noexcept
{
    return Cy_FourCCChar( nFourCC, 2u );
}

// Extracts the fourth byte from a FourCC.
CYPHER_NODISCARD constexpr char Cy_FourCCChar3( u32 nFourCC ) noexcept
{
    return Cy_FourCCChar( nFourCC, 3u );
}

// Returns true when a FourCC matches four expected ASCII characters.
CYPHER_NODISCARD constexpr bool_t Cy_FourCCMatches( u32 nFourCC, char ch0, char ch1, char ch2, char ch3 ) noexcept
{
    return nFourCC == Cy_MakeFourCC( ch0, ch1, ch2, ch3 );
}

// Converts host byte order to little-endian 16-bit order.
CYPHER_NODISCARD constexpr u16 Cy_HostToLittle16( u16 nValue ) noexcept
{
...
CYPHER_NODISCARD constexpr u32 Cy_HostToLittle32( u32 nValue ) noexcept
{
#if CYPHER_ENDIAN_LITTLE
    return nValue;
#else
...
CYPHER_NODISCARD constexpr u64 Cy_HostToLittle64( u64 nValue ) noexcept
{
#if CYPHER_ENDIAN_LITTLE
    return nValue;
#else
...
CYPHER_NODISCARD constexpr u16 Cy_LittleToHost16( u16 nValue ) noexcept
{
    return Cy_HostToLittle16( nValue );
}

// Converts little-endian 32-bit order to host byte order.
CYPHER_NODISCARD constexpr u32 Cy_LittleToHost32( u32 nValue ) noexcept
{
    return Cy_HostToLittle32( nValue );
}

// Converts little-endian 64-bit order to host byte order.
CYPHER_NODISCARD constexpr u64 Cy_LittleToHost64( u64 nValue ) noexcept
{
    return Cy_HostToLittle64( nValue );
}

// Converts host byte order to big-endian 16-bit order.
CYPHER_NODISCARD constexpr u16 Cy_HostToBig16( u16 nValue ) noexcept
{
...
CYPHER_NODISCARD constexpr u32 Cy_HostToBig32( u32 nValue ) noexcept
{
#if CYPHER_ENDIAN_BIG
    return nValue;
#else
...
CYPHER_NODISCARD constexpr u64 Cy_HostToBig64( u64 nValue ) noexcept
{
#if CYPHER_ENDIAN_BIG
    return nValue;
#else
...
CYPHER_NODISCARD constexpr u16 Cy_BigToHost16( u16 nValue ) noexcept
{
    return Cy_HostToBig16( nValue );
}

// Converts big-endian 32-bit order to host byte order.
CYPHER_NODISCARD constexpr u32 Cy_BigToHost32( u32 nValue ) noexcept
{
    return Cy_HostToBig32( nValue );
}

// Converts big-endian 64-bit order to host byte order.
CYPHER_NODISCARD constexpr u64 Cy_BigToHost64( u64 nValue ) noexcept
{
    return Cy_HostToBig64( nValue );
}

// Reverses the byte order of an IEEE-754 32-bit floating-point value.
CYPHER_NODISCARD constexpr f32 Cy_ByteSwapF32( f32 flValue ) noexcept
{
...
CYPHER_NODISCARD constexpr f64 Cy_ByteSwapF64( f64 flValue ) noexcept
{
...
CYPHER_NODISCARD constexpr f32 Cy_HostToLittleF32( f32 flValue ) noexcept
{
#if CYPHER_ENDIAN_LITTLE
    return flValue;
#else
...
CYPHER_NODISCARD constexpr f64 Cy_HostToLittleF64( f64 flValue ) noexcept
{
#if CYPHER_ENDIAN_LITTLE
    return flValue;
#else
...
CYPHER_NODISCARD constexpr f32 Cy_LittleToHostF32( f32 flValue ) noexcept
{
    return Cy_HostToLittleF32( flValue );
}

// Converts little-endian IEEE-754 64-bit order to host byte order.
CYPHER_NODISCARD constexpr f64 Cy_LittleToHostF64( f64 flValue ) noexcept
{
    return Cy_HostToLittleF64( flValue );
}

// Converts host byte order to big-endian IEEE-754 32-bit order.
CYPHER_NODISCARD constexpr f32 Cy_HostToBigF32( f32 flValue ) noexcept
{
#if CYPHER_ENDIAN_BIG
    return flValue;
#else
...
CYPHER_NODISCARD constexpr f64 Cy_HostToBigF64( f64 flValue ) noexcept
{
#if CYPHER_ENDIAN_BIG
    return flValue;
#else
...
CYPHER_NODISCARD constexpr f32 Cy_BigToHostF32( f32 flValue ) noexcept
{
    return Cy_HostToBigF32( flValue );
}

// Converts big-endian IEEE-754 64-bit order to host byte order.
CYPHER_NODISCARD constexpr f64 Cy_BigToHostF64( f64 flValue ) noexcept
{
...
CYPHER_NODISCARD inline u32 Cy_ReadLittle32( const void *pSrc ) noexcept
{
    u32 nValue = 0u;
    std::memcpy( &nValue, pSrc, sizeof( nValue ) );
...
CYPHER_NODISCARD inline u64 Cy_ReadLittle64( const void *pSrc ) noexcept
{
    u64 nValue = 0u;
    std::memcpy( &nValue, pSrc, sizeof( nValue ) );
...
CYPHER_NODISCARD inline u32 Cy_ReadBig32( const void *pSrc ) noexcept
{
    u32 nValue = 0u;
    std::memcpy( &nValue, pSrc, sizeof( nValue ) );
...
CYPHER_NODISCARD inline u64 Cy_ReadBig64( const void *pSrc ) noexcept
{
    u64 nValue = 0u;
    std::memcpy( &nValue, pSrc, sizeof( nValue ) );
...
CYPHER_NODISCARD inline f32 Cy_ReadBigF32( const void *pSrc ) noexcept
{
    return std::bit_cast<f32>( Cy_ReadBig32( pSrc ) );
}

// Reads an unaligned 64-bit big-endian floating-point value.
CYPHER_NODISCARD inline f64 Cy_ReadBigF64( const void *pSrc ) noexcept
{
