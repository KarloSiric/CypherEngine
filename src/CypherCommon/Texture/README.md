...
`Texture` is for public texture contracts.

Texture decoding, compression, GPU upload, and texture resource implementation
belong in image, asset, or renderer systems.
